...
public class LineTest 
{
	...
	Line line = new Line(1.0, 1.0, 1.0, 1.0);
		...
		public void testGetSlope()
		{
			...
			assertEquals(.75, line.getSlope(1.0,2.0,1.0,2.0), .0001);
			assertNotEquals(.01, line.getSlope(1.0,2.0,1.0,2.0),.0001);
		...
		public void testGetDistance()
		{
			...
			assertEquals(5.0, line.getDistance(1.0,2.0,1.0,2.0), .0001);
			assertNotEquals(.01, line.getDistance(1.0,2.0,1.0,2.0), .0001);
		...
		public void testParallelTo()
		{
			...
			assertEquals(.00001, line.parallelTo(1.0,1.0), .0001);
			assertNotEquals(.001, line.parallelTo(1.0,1.0), .0001);
		}
